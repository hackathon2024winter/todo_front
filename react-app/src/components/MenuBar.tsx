...
const MenuBar: FC = () => {
  return (
    <div className="bg-PoulBlue">
      <div className="flex  justify-between items-center px-2 py-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
